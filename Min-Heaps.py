# In this class there are print command which is use to understand better of what is happening in the class methods 
# The print statement is not necessary and can be remove without any harm to the code
# MinHeap is use to keep tracks of mimimum value in a data set
